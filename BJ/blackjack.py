...
class Play:
    ...
    def blackjack(self):
        ...
        if self.player.value == 21 and self.dealer.value == 21:
            gameDisplay.blit(show_dealer_card, (372, 200))
    ...
    def deal(self):
        ...
        gameDisplay.blit(dealer_card_2, (372, 200))
    ...
    def hit(self):
        ...
        self.player.calc_hand()
        self.player.display_cards()
        player_card = pygame.image.load('img/' + self.player.card_img[self.player_card] + '.png').convert()
        gameDisplay.blit(player_card, (self.card_coord, 450))
